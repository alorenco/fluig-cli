// fluig.d.ts — referência completa das APIs de script do TOTVS Fluig.
//
// Server-side (eventos em Rhino): hAPI, getValue (variáveis WK*),
// DatasetBuilder/DatasetFactory/Constraint, docAPI, fluigAPI e o SDK Java
// (com.fluig.sdk.*, java.util.*). Client-side (formulários e widgets):
// FormController (form.*), FLUIGC, WCMAPI, wdkAddChild, autocomplete.
// Consulte ESTE arquivo para assinaturas exatas antes de escrever código —
// não adivinhe métodos nem variáveis WK*.
//
// Fork mantido pelo fluigcli. Origem: fluig-declaration-type, da comunidade
// Fluiggers — https://github.com/fluiggers/fluig-declaration-type
// Licença MIT, Copyright (c) 2020 Bruno Gasparetto.
// Snapshot do master em 2026-07-21; alterações locais são permitidas (este
// fork é a referência canônica do fluigcli).
