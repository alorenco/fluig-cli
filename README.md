...
| `db` | `query` `grants` `datasources` | [docs/db.md](docs/db.md) |
...
| `audit` | linter do projeto: Style Guide 2.0, typos e usos frágeis de API, footguns do Rhino e, com `--process`, o cruzamento formulário × etapas do processo | [docs/audit.md](docs/audit.md) |
