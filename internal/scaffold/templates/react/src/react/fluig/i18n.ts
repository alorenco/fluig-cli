...
const messages: Record<string, Record<string, string>> = {
	pt_BR: {
		welcome: 'Widget [[.Code]] criada com fluigcli — edite o componente App e salve para ver o reload.',
	...
	en_US: {
		welcome: 'Widget [[.Code]] created with fluigcli — edit the App component and save to reload.',
	...
	es: {
		welcome: 'Widget [[.Code]] creada con fluigcli — edite el componente App y guarde para recargar.',
